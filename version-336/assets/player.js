...
(function () {
  function pickSource(index) {
    ...
    safeIndex = Math.abs(Math.floor(safeIndex)) % PLAYER_SOURCES.length;
    return PLAYER_SOURCES[safeIndex];
  }

  window.startMoviePlayer = function (sourceIndex) {
    var video = document.getElementById('movie-player');
    var cover = document.querySelector('[data-player-cover]');
    var source = pickSource(sourceIndex);
    var started = false;
